        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Text('Zaki Zakiran', style: AppTextStyle.homeLoc, textAlign: TextAlign.center,)),
              Center(
                child: SizedBox(
                  width: 340.w,
                  child: FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text('Zaki@gmail.com', style: AppTextStyle.profileEmail, textAlign: TextAlign.center,)),
                ),
              ),
              SizedBox(height: 14.h,),
              Container(
